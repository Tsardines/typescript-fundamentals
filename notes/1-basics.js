 ...
 */
var z; // z takes on a type called "any" (it's a wildcard)---it's aka a "Top Type"
z = 41;
 ...
 */
var zz; // this is called a "type annotation" // "You don't have an initializer, but I'm telling you what you're designed to hold"
zz = 41;
 ...
 */
var xx = [32, 31]; // number[]; // TS will consider this to be an arr of nums (and NOT a tuple)
var yy = [32, 31]; // So you need to have the [number, number] type annotation here to make it a tuple
//== OBJECTS ==//
/**
 ...
 */
var dd; // Note the ? ("It may or may not be there"---it's optional)
dd = {
    houseNumber: 33
};
